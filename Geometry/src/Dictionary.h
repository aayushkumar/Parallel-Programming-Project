...
#define __StGermain_Base_IO_Dictionary_h__
	...
	extern const char* Dictionary_Type;
	...
	*/
	...
	void Dictionary_AddWithSource( void* dictionary, Dictionary_Entry_Key key, Dictionary_Entry_Value* value,Dictionary_Entry_Units units, Dictionary_Entry_Source source );
	...
	/** Add an entry to the dictionary implementation */
	void _Dictionary_AddWithSource( void* dictionary, Dictionary_Entry_Key key, Dictionary_Entry_Value* value, Dictionary_Entry_Units units, Dictionary_Entry_Source source );
